...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        printCacluterMortgage(principal, annual, period);
        printPaymentSchedule(principal, annual, period);
    }

    private static void printCacluterMortgage(int principal, float annual, int period) {
    ...
    private static void printPaymentSchedule(int principal, float annual, int period) {
